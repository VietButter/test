...
class BossController {
	...
	@RequestMapping(value="/customers", params = "sortiere",method=RequestMethod.POST)
	public String customersSortiert(Model model) {

		model.addAttribute("customerList", customerRepository.findAllByOrderByAddress());
